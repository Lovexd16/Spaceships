...
public class WorldController {
    ...
    @GetMapping("/world/name/{worldName}")
    public World getWorldByName(@PathVariable String worldName) {
        return worldService.getWorldByName(worldName);
    }
    ...
    public World editWorldName(@PathVariable String id, @RequestBody World world) {
        return worldService.editWorldName(id, world);
    }
